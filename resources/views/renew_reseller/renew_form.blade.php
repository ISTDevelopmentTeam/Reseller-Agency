                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="membership_type" class="form-label">Type of
                                            Membership</label>
                                        <select class="form-select" id="membership_type" name="personal_info[membership_type]" required>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-select" id="plan_type" name="personal_info[plan_type]" required>
                                    ...
                                    <div class="vehicle-item border rounded p-3 mb-3">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control form-control-sm select2" id="make" name="vehicle_make[]"
                                                    required>
