                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" hidden>
                                            <div class="form-group">
                                                ...
                                                <input value="{{ old('restric') }}" name="restric" type="text" class="form-control form-control-sm"
                                            ...
                                            <div class="col-auto">
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input class="custom-control-input" type="radio" name="selection"
                                                        id="dlcode" value="dlcode" {{ old('selection') == 'dlcode' ? 'checked' : '' }}>
                                                ...
                                                <div class="restriction-checkboxes d-flex gap-5">
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <div class="custom-control custom-checkbox custom-control-inline checkboxes">
                                                            <input class="checkbox-btn custom-control-input restriction1" type="checkbox" name="restriction[]" id="{{ $i }}" value="{{ $i }}" {{ in_array($i, old('restriction', [])) ? 'checked' : '' }}>
                                                            <label class="custom-control-label fw-bold" for="{{ $i }}">{{ $i }}</label>
                                                        </div>
                                                    @endfor
                                                </div>
                                            </div>
