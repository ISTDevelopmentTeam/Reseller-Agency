...
<body>
    ...
    <div class="dashboard-main-body p-5">
        <div style="color:red">
            <p>Free emergency roadside and towing services can be availed of only after 7 days from the date of
                activation of membership.</p>
        </div>
                            ...
                            <div class="yellow-bottom">
                                @foreach ($results as $plan)
                                    @if ($plan->plan_id == 8)
                                        ...
                                        <a href="{{ route('new_reseller.index', ['planId' => $plan->plan_id]) }}"
                        ...
                        <div class="col-md-4">
                            <div class="yellow-bottom">
                                ...
                                <p>Register up to 2 vehicles. FREE 24/7 Emergency Roadside Assistance of 8 interventions
                                    ...
                                    Insurance.</p>
                                <button class="btn btn-custom"><a href="/pidp">APPLY NOW</a></button>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="yellow-bottom">
                        ...
                        <div class="col-md-6">
                            <div class="yellow-bottom">
                                ...
                                <p>Register up to 2 vehicles. FREE 24/7 Emergency Roadside Assistance of 4 interventions
                                    or 100-km tow distance, whichever comes first. FREE P300,000 Personal Accident
                                    Insurance.</p>
                                <button class="btn btn-custom"><a href="/membership">APPLY NOW</a></button>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="yellow-bottom">
