            ...
            <div class="card-body">
                <form id="resellerForm" action="{{ route('new_membership.store') }}" method="POST"
                    ...
                    <div class="form-step tab" id="step2">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                <label for="mail" class="form-label"><h5>Mailing Preference</h5></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-3 col-md-6 mb-4 with-number">
                                <label for="mobileNumber" class="form-label d-block">
                                    Mobile Number 
                            ...
                            <div class="col-xl-3 col-md-6 mb-4 with-number">
                                <label for="alternateMobile" class="form-label d-block">
                    ...
                    <div class="form-step tab" id="step3">
                        ...
                        <div id="vehicleFields" class="gap-5 mb-4">
                            <!-- Initial Vehicle Form -->
                            <div class="vehicle-item rounded p-3">
