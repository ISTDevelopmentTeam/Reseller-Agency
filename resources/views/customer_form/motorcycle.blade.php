...
<body>
        ...
        /* Keep your existing bordered class */
        .bordered {
                    ...
                    <div class="card-body">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" data-step="3">Beneficiaries</li>
                                <li class="breadcrumb-item" data-step="4">Motorcycle Details</li>
                        ...
                        <form id="resellerForm" action="{{ route('motorcycle.storing', ['token' => $token]) }}" method="POST"
                            ...
                            <div class="form-step tab" id="step3">
                                <div class="text">
                                    <p class="p1"><b>Note: </b>If Married, OTHER BENEFICIARIES pertains to spouse not more than 60 years old & unmarried children between ages 1-23 years.</p>
                                    <p class="p2">If Single, OTHER BENEFICIARIES refers to parents below 60 years old and unmarried brothers & sisters between ages 1-23 years.</p>
                                </div>

                                <!-- First Beneficiary (Always visible) -->
                                <div class="insured1">
                                    <div class="insured1 bordered">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="insuredBenefiaries1" class="form-label">Beneficiaries</label>
                                                    <select name="personal_info[insured1]" class="form-control form-control-sm" id="insuredBenefiaries1" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm fullname" placeholder="Enter Full Name" name="personal_info[beneficiary1]" id="insuredName1" autocomplete="off" required>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" placeholder="Enter Relationship" name="personal_info[relation1]" id="relationship1" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input name="personal_info[bday_insured1]" type="text" class="form-control form-control-sm" id="insuredBirthDate1" autocomplete="off" maxlength="10" placeholder="MM/DD/YYYY" required>
                                                    </div>
                                    ...
                                    <div class="insured2 bordered mt-3" style="display: none;">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="insuredBenefiaries2" class="form-label">Beneficiaries</label>
                                                    <select name="personal_info[insured2]" class="form-control form-control-sm" id="insuredBenefiaries2">
                                                        <option value="beneficiaries">BENEFICIARIES</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm fullname1" placeholder="Enter Full Name" name="personal_info[beneficiary2]" id="insuredName2" autocomplete="off">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" placeholder="Enter Relationship" name="personal_info[relation2]" id="relationship2" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm" placeholder="MM/DD/YYYY" name="personal_info[bday_insured2]" id="insuredBirthDate2" maxlength="10" autocomplete="off">
                                                    </div>
                                        ...
                                        <button type="button" onclick="removeBeneficiary(2)" class="btn btn-danger" style="display: none;" id="hide1">Remove this insured information</button>
                                    </div>

                                    <!-- Third Beneficiary (Initially Hidden) -->
                                    <div class="insured3 bordered mt-3" style="display: none;">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="insuredBenefiaries3" class="form-label">Beneficiaries</label>
                                                    <select name="personal_info[insured3]" class="form-control form-control-sm" id="insuredBenefiaries3">
                                                        <option value="beneficiaries">BENEFICIARIES</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm fullname2" placeholder="Enter Full Name" name="personal_info[beneficiary3]" id="insuredName3" autocomplete="off">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" placeholder="Enter Relationship" name="personal_info[relation3]" id="relationship3" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm" placeholder="MM/DD/YYYY" name="personal_info[bday_insured3]" id="insuredBirthDate3" maxlength="10" autocomplete="off">
                                                    </div>
                                        ...
                                        <button type="button" onclick="removeBeneficiary(3)" class="btn btn-danger" style="display: none;" id="hide2">Remove this insured information</button>
                                    </div>

                                    <!-- Single Add Button -->
                                    <button type="button" onclick="showNextBeneficiary()" class="btn btn-primary mt-3" id="addBeneficiaryBtn">+ Add Another Beneficiaries</button>
                                </div>
                            </div>
