...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-lg-8"> <!-- Adjusted column width -->
                <form id="resellerForm" action="{{ route('new_membership.store') }}" method="POST"
                    ...
                    <div class="card bordered">
                        <div class="text">
                            <p class="p1"><b>Note: </b>If Married, OTHER BENEFICIARIES pertains to spouse not more than
                                60
                                years old &
                                unmarried
                                children
                        ...
                        <div class="insured1">
                                ...
                                <div class="row mb-3" >
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="personal_info[insured1]" class="form-control form-control-sm "
                                                id="insuredBenefiaries1" required>
                                                <!-- <option value="" selected disabled>Select Beneficiaries.</option> -->
                                                <option value="beneficiaries" @if (old('personal_info.insured1') == "beneficiaries") {{ 'selected' }}
                                                @endif>BENEFICIARIES</option>
                                            </select>
                            ...
                            <div id="add_insured1">
                                <div class="insured2 bordered mt-3" style="display: none; width: 100%;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="personal_info[insured2]" class="form-control form-control-sm " id="insuredBenefiaries2">
                                                    <option value="beneficiaries" @if (old('personal_info.insured2') == "beneficiaries") {{ 'selected' }} @endif>BENEFICIARIES</option>
                                                </select>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value="{{old('personal_info.relationship2')}}" type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input value="{{old('personal_info.bday_insured2')}}" type="text"
                                                        class="form-control form-control-sm" placeholder="MM/DD/YYYY"
                                                        name="personal_info[bday_insured2]" id="insuredBirthDate2"
                                                        maxlength="10"
                                                        oninput="this.value = this.value.replace(/[^0-9/]/g, '')"
                                    ...
                                    <div>
                                        <button type="button" onclick="hidex()" class="btn btn-danger" id="hide1"
                                ...
                                <button type="button" onclick="show7()" class="btn btn-primary mt-3" id="add1"
                                    style="padding: .3rem 1.4rem; border-radius: .3rem;">+ Add another insured</button>
                            </div>
                            ...
                            <div id="add_insured2">
                                <div class="insured3 bordered mt-3" style="display: none; width: 100%;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="personal_info[insured3]"
                                                    ...
                                                    <!-- <option value="" selected disabled>Select Beneficiaries.</option> -->
                                                    <option value="beneficiaries" @if (old('personal_info.insured3') == "beneficiaries") {{ 'selected' }} @endif>BENEFICIARIES</option>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input value="{{old('personal_info.bday_insured3')}}" type="text"
                                                        class="form-control form-control-sm" placeholder="MM/DD/YYYY"
                                                        name="personal_info[bday_insured3]" id="insuredBirthDate3"
                                                        autocomplete="off"
                                                        oninput="this.value = this.value.replace(/[^0-9/]/g, '')"
                                    ...
                                    <br>
                                    <div>
                                        <button type="button" onclick="hidey()" class="btn btn-danger" id="hide2"
                                            style="margin: auto; padding: .3rem 1.4rem; border-radius: .3rem;">Remove
                                            this insured
                                            information</button>
                                    </div>
    ...
    <script src="/script/motorcycle.js"></script>
