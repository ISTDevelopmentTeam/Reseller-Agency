                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100">
                        <li class="w-100">
                            ...
                            <ul class="nav flex-column ms-4">
                                <li class="w-100">
                                    <a href="{{ route('new_reseller') }}" class="nav-link">
                                        <i class="fas fa-plus me-2"></i>
                                        <span class="ms-1">New</span>
                                    </a>
                                </li>
                                <li class="w-100">
                                    <a href="{{ route('renew_reseller') }}" class="nav-link">
                        ...
                        <li class="w-100">
                            <a href="{{ route('report_reseller') }}" class="nav-link">
                                <i class="fas fa-chart-bar me-2"></i>
                                <span class="ms-1">Report</span>
                            </a>
                        </li>
                        <li class="w-100">
                            <a href="{{ route('audit_trail') }}" class="nav-link active">
